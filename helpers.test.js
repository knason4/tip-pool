describe("Utilities test (with setup and tear-down"), function() {
    ...
    it('should generate new td from value and append ot tr on appendTd(tr, value)', function () {
    ...
    it('should generate delete td and append to tr on appendDeleteBtn(tr, typ)', function () {
        let newTr = document.createElement('tr');
